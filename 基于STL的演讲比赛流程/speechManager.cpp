...
void SpeechManager::speechContest()
{
    ...
    multimap<double, int, greater<int> > groupScore; //临时容器 key：分数 value：选手编号
...
{
    ofstream ofs;
    ofs.open("speech.csv", ios::out | ios::app);//通过append方式写文件
